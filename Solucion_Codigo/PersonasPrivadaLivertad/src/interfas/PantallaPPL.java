...
public class PantallaPPL extends javax.swing.JFrame {
    DefaultTableModel tabla= new DefaultTableModel();
    
    
    public PantallaPPL() {
        initComponents();
        String[] titulo=new String[]{"Genero","Nombres","Naacionalidad","Edad","DiasVPermitidos","ingreso","delitos","agravante"};
    ...
    void obtener(){
        ...
        for (H1_PersonaPrivadaLibertad p : personas) {
            tabla.addRow(new Object [] {p.getGenero(),p.getNombre(),p.getNacionalidad(),p.getEdad(),p.getDiasVPermitidos(),p.getFechaIngreso(),p.getDelitos(),p.getAgravantes()});
        }
        
    }
    void ultimocambio(){
        List<H1_PersonaPrivadaLibertad> personas = ProcesarPPL.obtenerPersonasPrivadasLibertad();
        H1_PersonaPrivadaLibertad p= personas.getLast();
        tabla.addRow(new Object [] {p.getGenero(),p.getNombre(),p.getNacionalidad(),p.getEdad(),p.getDiasVPermitidos(),p.getFechaIngreso(),p.getDelitos(),p.getAgravantes()});
    }
    ...
    private void initComponents() {
        ...
        obtenrd = new javax.swing.JButton();
        ObtenerDBG1 = new javax.swing.JButton();
        regresar = new javax.swing.JButton();
        obtener = new javax.swing.JLabel();
        ...
        getContentPane().add(jToggleButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 650, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 400, 980, 330));

        obtenrd.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        obtenrd.setText("obtener");
        obtenrd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                obtenrdActionPerformed(evt);
            }
        });
        getContentPane().add(obtenrd, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 360, -1, -1));
        ...
        getContentPane().add(ObtenerDBG1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 360, 170, 30));

        regresar.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        regresar.setText("ultimo cambio");
        regresar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                regresarActionPerformed(evt);
            }
        });
        getContentPane().add(regresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 360, -1, -1));

        obtener.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/fondo1.png"))); // NOI18N
        obtener.setText("jLabel2");
        getContentPane().add(obtener, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1820, 1000));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        persona.agregarDelito(new H1_T_Delito(obtener.getText(), _gravedadd.getText(), _descipciond.getText()));
        ...
        _visitaspermitidas.setText("");
        _edad1.setText("");
        _edad.setText(""); 
        _fechaingreso.setText(""); 
        _nombre1.setText(""); 
        _nacionalidad1.setText(""); 
        _genero1.setText(""); 
        obtener.setText("");              
        _gravedadd.setText(""); 
        _descipciond.setText(""); 
        _descripcion.setText(""); 
        _relacion.setText(""); 
        _telefono.setText(""); 
        _direccion.setText(""); 
        _identificacion.setText(""); 
        _nombre.setText(""); 
    ...
    private void obtenrdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_obtenrdActionPerformed
        obtener();
    }//GEN-LAST:event_obtenrdActionPerformed
    ...
    private javax.swing.JLabel obtener;
    private javax.swing.JButton obtenrd;
